...
describe('getCosmosDbConfig', () => {
  ...
  it('should return config with endpoint if environment variables are set', () => {
    const expectedDbName = 'my db name';
    const expectedEndpoint = 'my endpoint';

    process.env.VV_COSMOS_DB_NAME = expectedDbName;
    process.env.VV_COSMOS_DB_ENDPOINT = expectedEndpoint;
  ...
  it('should return config with endpoint from defaultConfig if environment variables are not set', () => {
    const expectedDbName = 'my db name';
    const expectedEndpoint = 'my endpoint';
